...
<body class="skin-blue">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="<?php echo base_url(); ?>" class="logo" target="_blank"><b>PT. Pandurasa</b></a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url() ?>assets/images/user/user3-128x128.jpg" class="user-image" alt="User Image"/>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        <small><?php echo $this->session->level ?></small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
